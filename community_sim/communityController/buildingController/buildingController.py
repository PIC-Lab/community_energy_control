...
class BuildingController:
    ...
    def LoadMPC(self):
        ...
        from buildingController.thermal_rc_model.modelConstructor import BuildingRC, ControllerSystem, Normalizer, ModeClassifier
        ...
        manager = RunManager(run, saveDir='../thermal_rc_model/savedRuns')
