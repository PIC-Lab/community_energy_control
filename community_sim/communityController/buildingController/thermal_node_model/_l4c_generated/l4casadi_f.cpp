...
L4CasADi l4casadi("/home/psalter/Documents/Leadville/leadville_community/community_sim/communityController/buildingController/thermal_node_model/_l4c_generated", "l4casadi_f", 1440, 3, 60, 1, "cuda:0", true, true, true, false, true, false);
...
static const casadi_int l4casadi_f_s_in0[3] = { 1440, 3, 1};
static const casadi_int l4casadi_f_s_out0[3] = { 60, 1, 1};
...
CASADI_SYMBOL_EXPORT int jac_adj1_l4casadi_f(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  ...
  if (res[0] == NULL) {
    l4casadi.invalid_argument("L4CasADi can only provide jac_adj_i0_i0 for jac_adj1_l4casadi_f function. If you need this feature, please contact the L4CasADi developer.");
  }
